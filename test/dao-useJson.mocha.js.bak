...
describe.skip('e2e:oolong:dao:useJson', function () {
    ...
    after(function () {
        ...
        let files = glob.sync(path.join(WORKING_FOLDER, 'oolong', '*.json-linked.json'));
