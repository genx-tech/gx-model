...
class Linker {
  ...
  loadElement(refererModule, elementType, elementName, throwOnMissing) {
    ...
    if (elementType === GemlTypes.Element.ENTITY && (_this$customizeEntiti = this.customizeEntities) !== null && _this$customizeEntiti !== void 0 && _this$customizeEntiti.has(elementName)) {
