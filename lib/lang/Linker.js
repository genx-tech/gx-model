...
class Linker {
  ...
  link(entryFileName) {
    ...
    if (!_.isEmpty((_entryModule$override = entryModule.overrides) === null || _entryModule$override === void 0 ? void 0 : _entryModule$override.entities)) {
